...
Config::Config() :
    ...
    n_pyr_levels(vk::getParam<int>("svo/n_pyr_levels", 8)),
    ...
    reproj_thresh(vk::getParam<double>("svo/reproj_thresh", 15.0)),
    poseoptim_thresh(vk::getParam<double>("svo/poseoptim_thresh", 15.0)),
    ...
    max_fts(vk::getParam<int>("svo/max_fts", 200)),
